        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">Three simple steps to transform your HR workflows</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="relative">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                  <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center text-white text-xl font-bold shadow-lg">
                    1
                  </div>
                  <div className="mt-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Design Your Workflow</h3>
                    <p className="text-gray-600 text-center">Drag and drop components to create your perfect workflow in our visual designer</p>
                  </div>
                </div>
              </div>
