      ...
      <div className="container mx-auto px-6 lg:px-8 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="space-y-8 animate-fadeInUp">
            <div>
              <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-white/80 backdrop-blur-sm border border-emerald-200 text-emerald-700 rounded-full text-sm font-semibold shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <NavLink
                to="/workflow-builder"
                className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl text-lg font-semibold hover:from-emerald-600 hover:to-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 group"
              >
                Start Building Free
              ...
              <NavLink
                to="/about"
                className="inline-flex items-center justify-center px-8 py-4 bg-white/80 backdrop-blur-sm border-2 border-gray-300 text-gray-800 rounded-xl text-lg font-semibold hover:bg-white hover:border-gray-400 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Know More
            ...
            <div className="flex items-center gap-6 pt-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600 font-medium">1,000+ HR Teams</span>
              </div>
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm text-gray-600 font-medium ml-1">5.0</span>
              </div>
            </div>
          </div>

          {/* Right Side - Feature Cards */}
          <div className="grid grid-cols-2 gap-4 lg:gap-6 animate-fadeInUp" style={{animationDelay: '0.2s'}}>

            {/* Feature Card 1 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-xl border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
              ...
              <p className="text-gray-600 font-medium">Faster approval cycles</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-xl border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
              ...
              <p className="text-gray-600 font-medium">Compliance assured</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-xl border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
              ...
              <p className="text-gray-600 font-medium">Analytics & insights</p>
            </div>

            {/* Large Feature Card */}
            <div className="col-span-2 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-300 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">Workflow Designer</h3>
                    <p className="text-gray-400 text-sm">Drag-and-drop interface</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-white/10 rounded-full text-xs font-medium">Templates</span>
                  <span className="px-3 py-1 bg-white/10 rounded-full text-xs font-medium">Automation</span>
                  <span className="px-3 py-1 bg-white/10 rounded-full text-xs font-medium">Testing</span>
                  <span className="px-3 py-1 bg-white/10 rounded-full text-xs font-medium">Deploy
</span>
                </div>
              </div>
            </div>
